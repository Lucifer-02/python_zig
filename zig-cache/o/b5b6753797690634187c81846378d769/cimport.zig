...
pub fn atof(arg___nptr: [*c]const u8) callconv(.C) f64 {
    ...
    return strtod(__nptr, @ptrCast([*c][*c]u8, @alignCast(@import("std").meta.alignment([*c][*c]u8), @intToPtr(?*anyopaque, @as(c_int, 0)))));
}
pub fn atoi(arg___nptr: [*c]const u8) callconv(.C) c_int {
    var __nptr = arg___nptr;
    return @bitCast(c_int, @truncate(c_int, strtol(__nptr, @ptrCast([*c][*c]u8, @alignCast(@import("std").meta.alignment([*c][*c]u8), @intToPtr(?*anyopaque, @as(c_int, 0)))), @as(c_int, 10))));
}
pub fn atol(arg___nptr: [*c]const u8) callconv(.C) c_long {
    var __nptr = arg___nptr;
    return strtol(__nptr, @ptrCast([*c][*c]u8, @alignCast(@import("std").meta.alignment([*c][*c]u8), @intToPtr(?*anyopaque, @as(c_int, 0)))), @as(c_int, 10));
}
pub fn atoll(arg___nptr: [*c]const u8) callconv(.C) c_longlong {
    var __nptr = arg___nptr;
    return strtoll(__nptr, @ptrCast([*c][*c]u8, @alignCast(@import("std").meta.alignment([*c][*c]u8), @intToPtr(?*anyopaque, @as(c_int, 0)))), @as(c_int, 10));
}
...
pub fn bsearch(arg___key: ?*const anyopaque, arg___base: ?*const anyopaque, arg___nmemb: usize, arg___size: usize, arg___compar: __compar_fn_t) callconv(.C) ?*anyopaque {
    ...
    while (__l < __u) {
        ...
        __p = @intToPtr(?*anyopaque, @ptrToInt(@ptrCast([*c]const u8, @alignCast(@import("std").meta.alignment([*c]const u8), __base)) + (__idx *% __size)));
...
pub extern fn futimesat(__fd: c_int, __file: [*c]const u8, __tvp: [*c]const struct_timeval) c_int; // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/timex.h:81:3: warning: struct demoted to opaque type - has bitfield
...
pub fn _Py_REFCNT(arg_ob: [*c]const PyObject) callconv(.C) Py_ssize_t {
    var ob = arg_ob;
    return ob.*.ob_refcnt;
}
...
pub fn _PyObject_TypeCheck(arg_ob: [*c]PyObject, arg_type: [*c]PyTypeObject) callconv(.C) c_int {
    var ob = arg_ob;
    var @"type" = arg_type;
    return @boolToInt((_Py_IS_TYPE(@ptrCast([*c]const PyObject, @alignCast(@import("std").meta.alignment([*c]const PyObject), ob)), @"type") != 0) or (PyType_IsSubtype(ob.*.ob_type, @"type") != 0));
}
...
pub fn _Py_XINCREF(arg_op: [*c]PyObject) callconv(.C) void {
    var op = arg_op;
    if (op != @ptrCast([*c]PyObject, @alignCast(@import("std").meta.alignment([*c]PyObject), @intToPtr(?*anyopaque, @as(c_int, 0))))) {
        _Py_INCREF(op);
    }
}
...
pub extern fn _PyType_GetModuleByDef([*c]PyTypeObject, [*c]struct_PyModuleDef) [*c]PyObject;
...
pub const struct__cframe = extern struct {
    use_tracing: c_int,
    previous: [*c]struct__cframe,
};
pub const CFrame = struct__cframe;
...
pub fn _PyType_CheckExact(arg_op: [*c]PyObject) callconv(.C) c_int {
    var op = arg_op;
    return _Py_IS_TYPE(@ptrCast([*c]const PyObject, @alignCast(@import("std").meta.alignment([*c]const PyObject), op)), &PyType_Type);
}
...
pub fn btowc(arg___c: c_int) callconv(.C) wint_t {
    var __c = arg___c;
    return if (((__builtin_constant_p(__c) != 0) and (__c >= @as(c_int, '\x00'))) and (__c <= @as(c_int, '\x7f'))) @bitCast(wint_t, __c) else __btowc_alias(__c);
}
pub fn wctob(arg___wc: wint_t) callconv(.C) c_int {
    var __wc = arg___wc;
    return if (((__builtin_constant_p(__wc) != 0) and (__wc >= @bitCast(c_uint, @as(c_int, '\u{0}')))) and (__wc <= @bitCast(c_uint, @as(c_int, '\u{7f}')))) @bitCast(c_int, __wc) else __wctob_alias(__wc);
}
...
pub fn mbrlen(noalias arg___s: [*c]const u8, arg___n: usize, noalias arg___ps: [*c]mbstate_t) callconv(.C) usize {
    ...
    var __n = arg___n;
    var __ps = arg___ps;
    return if (__ps != @ptrCast([*c]mbstate_t, @alignCast(@import("std").meta.alignment([*c]mbstate_t), @intToPtr(?*anyopaque, @as(c_int, 0))))) mbrtowc(null, __s, __n, __ps) else __mbrlen(__s, __n, null);
}
...
} // /usr/include/python3.10/cpython/unicodeobject.h:171:22: warning: struct demoted to opaque type - has bitfield
...
pub fn _PyUnicode_get_wstr_length(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    var op = arg_op;
    return if ((@bitCast(c_int, @ptrCast(?*PyASCIIObject, @alignCast(@import("std").meta.alignment(?*PyASCIIObject), op)).*.state.ascii) != 0) and (@bitCast(c_int, @ptrCast(?*PyASCIIObject, @alignCast(@import("std").meta.alignment(?*PyASCIIObject), op)).*.state.compact) != 0)) @ptrCast(?*PyASCIIObject, @alignCast(@import("std").meta.alignment(?*PyASCIIObject), op)).*.length else @ptrCast(?*PyCompactUnicodeObject, @alignCast(@import("std").meta.alignment(?*PyCompactUnicodeObject), op)).*.wstr_length;
}
...
pub extern fn _PyDict_ContainsId([*c]PyObject, [*c]struct__Py_Identifier) c_int;
...
pub extern fn _PyDict_GetItemHint([*c]PyDictObject, [*c]PyObject, Py_ssize_t, [*c][*c]PyObject) Py_ssize_t;
...
pub const PyFrameConstructor = extern struct {
    fc_globals: [*c]PyObject,
    fc_builtins: [*c]PyObject,
    fc_name: [*c]PyObject,
    fc_qualname: [*c]PyObject,
    fc_code: [*c]PyObject,
    fc_defaults: [*c]PyObject,
    fc_kwdefaults: [*c]PyObject,
    fc_closure: [*c]PyObject,
};
pub const PyFunctionObject = extern struct {
    ob_base: PyObject,
    func_globals: [*c]PyObject,
    func_builtins: [*c]PyObject,
...
pub extern fn _PyCode_InitAddressRange(co: [*c]PyCodeObject, bounds: [*c]PyCodeAddressRange) c_int;
pub extern fn PyLineTable_InitAddressRange(linetable: [*c]const u8, length: Py_ssize_t, firstlineno: c_int, range: [*c]PyCodeAddressRange) void;
pub extern fn PyLineTable_NextAddressRange(range: [*c]PyCodeAddressRange) c_int;
pub extern fn PyLineTable_PreviousAddressRange(range: [*c]PyCodeAddressRange) c_int;
...
pub fn PyVectorcall_Function(arg_callable: [*c]PyObject) callconv(.C) vectorcallfunc {
    ...
    _ = @as(c_int, 0);
    _ = memcpy(@ptrCast(?*anyopaque, &ptr), @ptrCast(?*const anyopaque, @ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), callable)) + @bitCast(usize, @intCast(isize, offset))), @sizeOf(vectorcallfunc));
    return ptr;
}
pub fn _PyObject_VectorcallTstate(arg_tstate: [*c]PyThreadState, arg_callable: [*c]PyObject, arg_args: [*c]const [*c]PyObject, arg_nargsf: usize, arg_kwnames: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    if (func == @ptrCast(vectorcallfunc, @alignCast(@import("std").meta.alignment(vectorcallfunc), @intToPtr(?*anyopaque, @as(c_int, 0))))) {
...
pub fn PyObject_CallOneArg(arg_func: [*c]PyObject, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = @as(c_int, 0);
    args = @ptrCast([*c][*c]PyObject, @alignCast(@import("std").meta.alignment([*c][*c]PyObject), &_args)) + @bitCast(usize, @intCast(isize, @as(c_int, 1)));
...
pub fn PyObject_CallMethodOneArg(arg_self: [*c]PyObject, arg_name: [*c]PyObject, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = @as(c_int, 0);
    return PyObject_VectorcallMethod(name, @ptrCast([*c][*c]PyObject, @alignCast(@import("std").meta.alignment([*c][*c]PyObject), &args)), @bitCast(c_ulong, @as(c_long, @as(c_int, 2))) | (@bitCast(usize, @as(c_long, @as(c_int, 1))) << @intCast(@import("std").math.Log2Int(usize), (@bitCast(c_ulong, @as(c_long, @as(c_int, 8))) *% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))), null);
}
...
pub fn _PyObject_CallMethodIdOneArg(arg_self: [*c]PyObject, arg_name: [*c]_Py_Identifier, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = @as(c_int, 0);
    return _PyObject_VectorcallMethodId(name, @ptrCast([*c][*c]PyObject, @alignCast(@import("std").meta.alignment([*c][*c]PyObject), &args)), @bitCast(c_ulong, @as(c_long, @as(c_int, 2))) | (@bitCast(usize, @as(c_long, @as(c_int, 1))) << @intCast(@import("std").math.Log2Int(usize), (@bitCast(c_ulong, @as(c_long, @as(c_int, 8))) *% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))), null);
}
...
pub const PySyntaxErrorObject = extern struct {
    ...
    lineno: [*c]PyObject,
    offset: [*c]PyObject,
    end_lineno: [*c]PyObject,
    end_offset: [*c]PyObject,
    text: [*c]PyObject,
...
pub extern fn pthread_mutexattr_getrobust_np([*c]pthread_mutex_t, [*c]c_int) c_int;
pub extern fn pthread_mutexattr_setrobust(__attr: [*c]pthread_mutexattr_t, __robustness: c_int) c_int;
pub extern fn pthread_mutexattr_setrobust_np([*c]pthread_mutex_t, c_int) c_int;
...
pub extern fn _PyArg_Parse_SizeT([*c]PyObject, [*c]const u8, ...) c_int;
pub extern fn _PyArg_ParseTuple_SizeT([*c]PyObject, [*c]const u8, ...) c_int;
pub extern fn _PyArg_ParseTupleAndKeywords_SizeT([*c]PyObject, [*c]PyObject, [*c]const u8, [*c][*c]u8, ...) c_int;
pub extern fn _PyArg_VaParse_SizeT([*c]PyObject, [*c]const u8, [*c]struct___va_list_tag) c_int;
pub extern fn _PyArg_VaParseTupleAndKeywords_SizeT([*c]PyObject, [*c]PyObject, [*c]const u8, [*c][*c]u8, [*c]struct___va_list_tag) c_int;
...
pub extern fn _PyArg_ParseTupleAndKeywordsFast_SizeT([*c]PyObject, [*c]PyObject, [*c]struct__PyArg_Parser, ...) c_int;
pub extern fn _PyArg_ParseStack_SizeT(args: [*c]const [*c]PyObject, nargs: Py_ssize_t, format: [*c]const u8, ...) c_int;
pub extern fn _PyArg_ParseStackAndKeywords_SizeT(args: [*c]const [*c]PyObject, nargs: Py_ssize_t, kwnames: [*c]PyObject, [*c]struct__PyArg_Parser, ...) c_int;
pub extern fn _PyArg_VaParseTupleAndKeywordsFast_SizeT([*c]PyObject, [*c]PyObject, [*c]struct__PyArg_Parser, [*c]struct___va_list_tag) c_int;
...
pub const __INT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `L`"); // (no file):170:9
pub const __UINT32_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `U`"); // (no file):192:9
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // (no file):200:9
...
pub const __GLIBC_USE = @compileError("unable to translate macro: undefined identifier `__GLIBC_USE_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/features.h:186:9
pub const __glibc_has_attribute = @compileError("unable to translate macro: undefined identifier `__has_attribute`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:44:10
pub const __glibc_has_extension = @compileError("unable to translate macro: undefined identifier `__has_extension`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:54:10
pub const __THROW = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:78:11
pub const __THROWNL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:79:11
pub const __NTH = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:80:11
pub const __NTHNL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:81:11
pub const __CONCAT = @compileError("unable to translate C expr: unexpected token '##'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:123:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token '#'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:124:9
pub const __warnattr = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:158:10
pub const __errordecl = @compileError("unable to translate C expr: unexpected token 'extern'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:159:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token '['"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:167:10
pub const __REDIRECT = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:198:10
pub const __REDIRECT_NTH = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:205:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:207:11
pub const __ASMNAME2 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:211:10
pub const __attribute_malloc__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:232:10
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:243:10
pub const __attribute_pure__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:250:10
pub const __attribute_const__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:257:10
pub const __attribute_maybe_unused__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:263:10
pub const __attribute_used__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:272:10
pub const __attribute_noinline__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:273:10
pub const __attribute_deprecated__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:281:10
pub const __attribute_deprecated_msg__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:291:10
pub const __attribute_format_arg__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:304:10
pub const __attribute_format_strfmon__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:314:10
pub const __nonnull = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:324:11
pub const __returns_nonnull = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:337:10
pub const __attribute_warn_unused_result__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:346:10
pub const __always_inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:364:10
pub const __attribute_artificial__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:373:10
pub const __extern_inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:391:11
pub const __extern_always_inline = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:392:11
pub const __restrict_arr = @compileError("unable to translate macro: undefined identifier `__restrict`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:435:10
pub const __attribute_copy__ = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:484:10
pub const __LDBL_REDIR2_DECL = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:560:10
pub const __LDBL_REDIR_DECL = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:561:10
pub const __glibc_macro_warning1 = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:575:10
pub const __glibc_macro_warning = @compileError("unable to translate macro: undefined identifier `GCC`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:576:10
pub const __attr_access = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:612:11
pub const __attr_access_none = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:613:11
pub const __attr_dealloc = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:623:10
pub const __attribute_returns_twice__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/cdefs.h:630:10
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/include/stdarg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/include/stdarg.h:27:9
pub const __STD_TYPE = @compileError("unable to translate C expr: unexpected token 'typedef'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/types.h:137:10
pub const __FSID_T_TYPE = @compileError("unable to translate macro: undefined identifier `__val`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/x86_64-linux-gnu/bits/typesizes.h:73:9
pub const __getc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:102:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:106:9
pub const __CFLOAT32 = @compileError("unable to translate: TODO _Complex"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:149:12
pub const __CFLOAT64 = @compileError("unable to translate: TODO _Complex"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:160:13
pub const __CFLOAT32X = @compileError("unable to translate: TODO _Complex"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:169:12
pub const __CFLOAT64X = @compileError("unable to translate: TODO _Complex"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:178:13
pub const __builtin_nansf32 = @compileError("unable to translate macro: undefined identifier `__builtin_nansf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:221:12
pub const __builtin_huge_valf64 = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:255:13
pub const __builtin_inff64 = @compileError("unable to translate macro: undefined identifier `__builtin_inf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:256:13
pub const __builtin_nanf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nan`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:257:13
pub const __builtin_nansf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nans`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:258:13
pub const __builtin_huge_valf32x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:272:12
pub const __builtin_inff32x = @compileError("unable to translate macro: undefined identifier `__builtin_inf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:273:12
pub const __builtin_nanf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nan`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:274:12
pub const __builtin_nansf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nans`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:275:12
pub const __builtin_huge_valf64x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:289:13
pub const __builtin_inff64x = @compileError("unable to translate macro: undefined identifier `__builtin_infl`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:290:13
pub const __builtin_nanf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nanl`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:291:13
pub const __builtin_nansf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/floatn-common.h:292:13
pub const strdupa = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/string.h:185:10
pub const strndupa = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/string.h:195:10
pub const __FD_ZERO = @compileError("unable to translate macro: undefined identifier `__i`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')' instead got '|='"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')' instead got '&='"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/select.h:34:9
pub const __PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/x86_64-linux-gnu/bits/struct_mutex.h:56:10
pub const __PTHREAD_RWLOCK_ELISION_EXTRA = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/x86_64-linux-gnu/bits/struct_rwlock.h:40:11
pub const __ONCE_FLAG_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/thread-shared-types.h:127:9
pub const TEMP_FAILURE_RETRY = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/unistd.h:1131:10
pub const __ASSERT_VOID_CAST = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/assert.h:40:10
pub const static_assert = @compileError("unable to translate C expr: unexpected token '_Static_assert'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/assert.h:140:10
pub const Py_LOCAL = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.10/pyport.h:196:11
pub const Py_LOCAL_INLINE = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.10/pyport.h:197:11
pub const HUGE_VAL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:48:10
pub const HUGE_VALL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:60:11
pub const SNANF = @compileError("unable to translate macro: undefined identifier `__builtin_nansf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:110:11
pub const SNAN = @compileError("unable to translate macro: undefined identifier `__builtin_nans`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:111:11
pub const SNANL = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:112:11
pub const __SIMD_DECL = @compileError("unable to translate macro: undefined identifier `__DECL_SIMD_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:276:9
pub const __MATHCALL_VEC = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:278:9
pub const __MATHDECL_VEC = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:282:9
pub const __MATHDECL = @compileError("unable to translate macro: undefined identifier `__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:288:9
pub const __MATHDECLX = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:293:9
pub const __MATHDECL_1_IMPL = @compileError("unable to translate C expr: unexpected token 'extern'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:296:9
pub const __MATHREDIR = @compileError("unable to translate C expr: unexpected token 'extern'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:305:9
pub const __MATHCALL_NARROW_ARGS_1 = @compileError("unable to translate macro: undefined identifier `__x`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:550:9
pub const __MATHCALL_NARROW_ARGS_2 = @compileError("unable to translate macro: undefined identifier `__x`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:551:9
pub const __MATHCALL_NARROW_ARGS_3 = @compileError("unable to translate macro: undefined identifier `__x`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:552:9
pub const __MATHCALL_NARROW_NORMAL = @compileError("unable to translate macro: undefined identifier `__MATHCALL_NARROW_ARGS_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:553:9
pub const __MATHCALL_NARROW_REDIR = @compileError("unable to translate macro: undefined identifier `__MATHCALL_NARROW_ARGS_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:555:9
pub const __MATHCALL_NAME = @compileError("unable to translate macro: undefined identifier `f`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:565:10
pub const __MATH_TG = @compileError("unable to translate macro: undefined identifier `f`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:916:10
pub const fpclassify = @compileError("unable to translate macro: undefined identifier `__builtin_fpclassify`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:961:11
pub const isfinite = @compileError("unable to translate macro: undefined identifier `__builtin_isfinite`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:988:11
pub const isnormal = @compileError("unable to translate macro: undefined identifier `__builtin_isnormal`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:996:11
pub const __iscanonicalf = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/x86_64-linux-gnu/bits/iscanonical.h:25:9
pub const __iscanonical = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/x86_64-linux-gnu/bits/iscanonical.h:26:9
pub const iszero = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:1088:12
pub const isgreater = @compileError("unable to translate macro: undefined identifier `__builtin_isgreater`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:1282:11
pub const isgreaterequal = @compileError("unable to translate macro: undefined identifier `__builtin_isgreaterequal`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:1283:11
pub const isless = @compileError("unable to translate macro: undefined identifier `__builtin_isless`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:1284:11
pub const islessequal = @compileError("unable to translate macro: undefined identifier `__builtin_islessequal`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:1285:11
pub const islessgreater = @compileError("unable to translate macro: undefined identifier `__builtin_islessgreater`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:1286:11
pub const isunordered = @compileError("unable to translate macro: undefined identifier `__builtin_isunordered`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/math.h:1287:11
pub const TIMEVAL_TO_TIMESPEC = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/time.h:38:10
pub const TIMESPEC_TO_TIMEVAL = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/time.h:42:10
pub const timerclear = @compileError("unable to translate C expr: expected ')' instead got '='"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/time.h:232:10
pub const timercmp = @compileError("unable to translate C expr: expected ')' instead got 'Identifier'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/time.h:233:10
pub const timeradd = @compileError("unable to translate C expr: unexpected token 'do'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/time.h:237:10
pub const timersub = @compileError("unable to translate C expr: unexpected token 'do'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sys/time.h:247:10
pub const st_atime = @compileError("unable to translate macro: undefined identifier `st_atim`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/x86_64-linux-gnu/bits/struct_stat.h:77:11
pub const st_mtime = @compileError("unable to translate macro: undefined identifier `st_mtim`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/x86_64-linux-gnu/bits/struct_stat.h:78:11
pub const st_ctime = @compileError("unable to translate macro: undefined identifier `st_ctim`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/x86_64-linux-gnu/bits/struct_stat.h:79:11
pub const __struct_group = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/any-linux-any/linux/stddef.h:23:9
pub const __DECLARE_FLEX_ARRAY = @compileError("unable to translate macro: undefined identifier `__empty_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/any-linux-any/linux/stddef.h:39:9
pub const __aligned_u64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/any-linux-any/linux/types.h:43:9
pub const __aligned_be64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/any-linux-any/linux/types.h:44:9
pub const __aligned_le64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/any-linux-any/linux/types.h:45:9
pub const _Py_SET_EDOM_FOR_NAN = @compileError("unable to translate C expr: unexpected token ';'"); // /usr/include/python3.10/pyport.h:335:9
pub const Py_SET_ERRNO_ON_MATH_ERROR = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.10/pyport.h:337:9
pub const Py_ADJUST_ERANGE1 = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.10/pyport.h:365:9
pub const Py_ADJUST_ERANGE2 = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.10/pyport.h:375:9
pub const _Py_SET_53BIT_PRECISION_HEADER = @compileError("unable to translate macro: undefined identifier `old_387controlword`"); // /usr/include/python3.10/pyport.h:413:9
pub const _Py_SET_53BIT_PRECISION_START = @compileError("unable to translate macro: undefined identifier `old_387controlword`"); // /usr/include/python3.10/pyport.h:415:9
pub const _Py_SET_53BIT_PRECISION_END = @compileError("unable to translate macro: undefined identifier `new_387controlword`"); // /usr/include/python3.10/pyport.h:422:9
pub const Py_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.10/pyport.h:513:9
pub const _Py_COMP_DIAG_PUSH = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /usr/include/python3.10/pyport.h:522:9
pub const _Py_COMP_DIAG_IGNORE_DEPR_DECLS = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /usr/include/python3.10/pyport.h:523:9
pub const _Py_COMP_DIAG_POP = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /usr/include/python3.10/pyport.h:525:9
pub const _Py_NO_INLINE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.10/pyport.h:574:11
pub const Py_IMPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.10/exports.h:20:17
pub const Py_EXPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.10/exports.h:21:17
pub const Py_LOCAL_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.10/exports.h:22:17
pub const PyAPI_DATA = @compileError("unable to translate C expr: unexpected token 'extern'"); // /usr/include/python3.10/pyport.h:706:16
pub const PyMODINIT_FUNC = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/python3.10/pyport.h:712:24
pub const Py_GCC_ATTRIBUTE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.10/pyport.h:760:9
pub const Py_ALIGNED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.10/pyport.h:767:9
pub const Py_ULL = @compileError("unable to translate macro: undefined identifier `U`"); // /usr/include/python3.10/pyport.h:784:9
pub const _Py_NO_RETURN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/python3.10/pyport.h:869:11
pub const _Py_XSTRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.10/pymacro.h:13:9
pub const Py_MEMBER_SIZE = @compileError("unable to translate C expr: unexpected token '('"); // /usr/include/python3.10/pymacro.h:22:9
pub const Py_BUILD_ASSERT_EXPR = @compileError("unable to translate C expr: expected ')' instead got '['"); // /usr/include/python3.10/pymacro.h:39:9
pub const Py_BUILD_ASSERT = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.10/pymacro.h:42:9
pub const Py_ARRAY_LENGTH = @compileError("unable to translate macro: undefined identifier `__builtin_types_compatible_p`"); // /usr/include/python3.10/pymacro.h:59:9
pub const PyDoc_VAR = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.10/pymacro.h:70:9
pub const PyDoc_STRVAR = @compileError("unable to translate C expr: unexpected token '='"); // /usr/include/python3.10/pymacro.h:71:9
pub const Py_UNUSED = @compileError("unable to translate macro: undefined identifier `_unused_`"); // /usr/include/python3.10/pymacro.h:98:11
pub const _Py_IntegralTypeMax = @compileError("unable to translate C expr: expected ')' instead got 'IntegerLiteral'"); // /usr/include/python3.10/pymath.h:221:9
pub const PyMem_New = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.10/pymem.h:67:9
pub const PyMem_Resize = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.10/pymem.h:77:9
pub const PyObject_HEAD = @compileError("unable to translate macro: undefined identifier `ob_base`"); // /usr/include/python3.10/object.h:82:9
pub const PyObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.10/object.h:84:9
pub const PyVarObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.10/object.h:88:9
pub const PyObject_VAR_HEAD = @compileError("unable to translate macro: undefined identifier `ob_base`"); // /usr/include/python3.10/object.h:97:9
pub const _PyObject_CAST_CONST = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.10/object.h:113:9
pub const _PyVarObject_CAST_CONST = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.10/object.h:122:9
pub const Py_CLEAR = @compileError("unable to translate macro: undefined identifier `_py_tmp`"); // /usr/include/python3.10/object.h:545:9
pub const Py_RETURN_NONE = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.10/object.h:613:9
pub const Py_RETURN_NOTIMPLEMENTED = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.10/object.h:623:9
pub const Py_RETURN_RICHCOMPARE = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.10/object.h:647:9
pub const _Py_static_string_init = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.10/cpython/object.h:44:9
pub const _Py_static_string = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.10/cpython/object.h:45:9
pub const _Py_IDENTIFIER = @compileError("unable to translate macro: undefined identifier `PyId_`"); // /usr/include/python3.10/cpython/object.h:46:9
pub const PyHeapType_GET_MEMBERS = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.10/cpython/object.h:296:9
pub const Py_SETREF = @compileError("unable to translate macro: undefined identifier `_py_tmp`"); // /usr/include/python3.10/cpython/object.h:366:9
pub const Py_XSETREF = @compileError("unable to translate macro: undefined identifier `_py_tmp`"); // /usr/include/python3.10/cpython/object.h:373:9
pub const _PyObject_ASSERT_WITH_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /usr/include/python3.10/cpython/object.h:422:9
pub const _PyObject_ASSERT_FAILED_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /usr/include/python3.10/cpython/object.h:427:9
pub const Py_TRASHCAN_BEGIN_CONDITION = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /usr/include/python3.10/cpython/object.h:527:9
pub const Py_TRASHCAN_END = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /usr/include/python3.10/cpython/object.h:539:9
pub const PyObject_New = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.10/objimpl.h:134:9
pub const PyObject_NewVar = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.10/objimpl.h:140:9
pub const PyObject_GC_Resize = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.10/objimpl.h:164:9
pub const PyObject_GC_New = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.10/objimpl.h:184:9
pub const PyObject_GC_NewVar = @compileError("unable to translate C expr: unexpected token ')'"); // /usr/include/python3.10/objimpl.h:186:9
pub const Py_VISIT = @compileError("unable to translate macro: undefined identifier `vret`"); // /usr/include/python3.10/objimpl.h:197:9
pub const __exctype = @compileError("unable to translate C expr: unexpected token 'extern'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/ctype.h:102:9
pub const __tobody = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/ctype.h:155:9
pub const __exctype_l = @compileError("unable to translate C expr: unexpected token 'extern'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/ctype.h:244:10
pub const PyUnicode_AS_DATA = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.10/cpython/unicodeobject.h:282:9
pub const PyUnicode_WRITE = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.10/cpython/unicodeobject.h:363:9
pub const PyUnicode_READ = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.10/cpython/unicodeobject.h:383:9
pub const PyUnicode_READ_CHAR = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/python3.10/cpython/unicodeobject.h:397:9
pub const Py_RETURN_TRUE = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.10/boolobject.h:34:9
pub const Py_RETURN_FALSE = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.10/boolobject.h:35:9
pub const Py_RETURN_NAN = @compileError("unable to translate C expr: unexpected token 'return'"); // /usr/include/python3.10/floatobject.h:27:9
pub const Py_RETURN_INF = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/python3.10/floatobject.h:30:9
pub const PyTuple_SET_ITEM = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.10/cpython/tupleobject.h:26:9
pub const PyList_SET_ITEM = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.10/cpython/listobject.h:33:9
pub const PyModuleDef_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.10/moduleobject.h:51:9
pub const COMMON_FIELDS = @compileError("unable to translate macro: undefined identifier `globals`"); // /usr/include/python3.10/funcobject.h:11:9
pub const PyCell_SET = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.10/cellobject.h:23:9
pub const _PyGenObject_HEAD = @compileError("unable to translate macro: undefined identifier `_code`"); // /usr/include/python3.10/genobject.h:16:9
pub const PyDescr_COMMON = @compileError("unable to translate macro: undefined identifier `d_common`"); // /usr/include/python3.10/descrobject.h:48:9
pub const PyException_HEAD = @compileError("unable to translate macro: undefined identifier `dict`"); // /usr/include/python3.10/cpython/pyerrors.h:8:9
pub const __CPU_ZERO_S = @compileError("unable to translate C expr: unexpected token 'do'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/cpu-set.h:46:10
pub const __CPU_SET_S = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/cpu-set.h:58:9
pub const __CPU_CLR_S = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/cpu-set.h:65:9
pub const __CPU_ISSET_S = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/cpu-set.h:72:9
pub const __CPU_EQUAL_S = @compileError("unable to translate macro: undefined identifier `__builtin_memcmp`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/cpu-set.h:84:10
pub const __CPU_OP_S = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/bits/cpu-set.h:99:9
pub const __sched_priority = @compileError("unable to translate macro: undefined identifier `sched_priority`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sched.h:48:9
pub const CPU_AND = @compileError("unable to translate C expr: unexpected token ')'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sched.h:111:10
pub const CPU_OR = @compileError("unable to translate C expr: unexpected token '|'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sched.h:113:10
pub const CPU_XOR = @compileError("unable to translate C expr: unexpected token '^'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sched.h:115:10
pub const CPU_AND_S = @compileError("unable to translate C expr: unexpected token ')'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sched.h:117:10
pub const CPU_OR_S = @compileError("unable to translate C expr: unexpected token '|'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sched.h:119:10
pub const CPU_XOR_S = @compileError("unable to translate C expr: unexpected token '^'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/sched.h:121:10
pub const PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:90:9
pub const PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:93:10
pub const PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:95:10
pub const PTHREAD_ADAPTIVE_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:97:10
pub const PTHREAD_RWLOCK_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:114:10
pub const PTHREAD_RWLOCK_WRITER_NONRECURSIVE_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:117:11
pub const PTHREAD_COND_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:155:9
pub const pthread_cleanup_push = @compileError("unable to translate macro: undefined identifier `__cancel_buf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:681:10
pub const pthread_cleanup_pop = @compileError("unable to translate macro: undefined identifier `__cancel_buf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:702:10
pub const pthread_cleanup_push_defer_np = @compileError("unable to translate macro: undefined identifier `__cancel_buf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:716:11
pub const pthread_cleanup_pop_restore_np = @compileError("unable to translate macro: undefined identifier `__cancel_buf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig-dev/lib/libc/include/generic-glibc/pthread.h:738:11
pub const Py_tss_NEEDS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.10/pythread.h:151:9
pub const PyModule_AddIntMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.10/modsupport.h:154:9
pub const PyModule_AddStringMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /usr/include/python3.10/modsupport.h:155:9
pub const Py_BEGIN_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /usr/include/python3.10/ceval.h:132:9
pub const Py_BLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /usr/include/python3.10/ceval.h:135:9
pub const Py_UNBLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /usr/include/python3.10/ceval.h:136:9
pub const Py_END_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /usr/include/python3.10/ceval.h:137:9
pub const PyFPE_START_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/python3.10/cpython/pyfpe.h:11:9
pub const PyFPE_END_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/python3.10/cpython/pyfpe.h:12:9
...
pub const PY_SSIZE_T_CLEAN = @as(c_int, 1);
...
pub const PY_MINOR_VERSION = @as(c_int, 10);
pub const PY_MICRO_VERSION = @as(c_int, 6);
pub const PY_RELEASE_LEVEL = PY_RELEASE_LEVEL_FINAL;
pub const PY_RELEASE_SERIAL = @as(c_int, 0);
pub const PY_VERSION = "3.10.6";
...
pub const HAVE_LIBUUID = @as(c_int, 1);
...
pub inline fn Py_REFCNT(ob: anytype) @TypeOf(_Py_REFCNT(_PyObject_CAST_CONST(ob))) {
    return _Py_REFCNT(_PyObject_CAST_CONST(ob));
}
...
pub inline fn PyObject_TypeCheck(ob: anytype, @"type": anytype) @TypeOf(_PyObject_TypeCheck(_PyObject_CAST(ob), @"type")) {
    return _PyObject_TypeCheck(_PyObject_CAST(ob), @"type");
}
...
pub inline fn PyFunction_AS_FRAME_CONSTRUCTOR(func: anytype) [*c]PyFrameConstructor {
    return @import("std").zig.c_translation.cast([*c]PyFrameConstructor, &@import("std").zig.c_translation.cast([*c]PyFunctionObject, func).*.func_globals);
}
...
pub const _PyObject_CallMethodId = _PyObject_CallMethodId_SizeT;
...
pub const PyArg_Parse = _PyArg_Parse_SizeT;
pub const PyArg_ParseTuple = _PyArg_ParseTuple_SizeT;
pub const PyArg_ParseTupleAndKeywords = _PyArg_ParseTupleAndKeywords_SizeT;
pub const PyArg_VaParse = _PyArg_VaParse_SizeT;
pub const PyArg_VaParseTupleAndKeywords = _PyArg_VaParseTupleAndKeywords_SizeT;
pub const Py_BuildValue = _Py_BuildValue_SizeT;
pub const Py_VaBuildValue = _Py_VaBuildValue_SizeT;
pub const _Py_VaBuildStack = _Py_VaBuildStack_SizeT;
pub const _PyArg_ParseTupleAndKeywordsFast = _PyArg_ParseTupleAndKeywordsFast_SizeT;
pub const _PyArg_ParseStack = _PyArg_ParseStack_SizeT;
pub const _PyArg_ParseStackAndKeywords = _PyArg_ParseStackAndKeywords_SizeT;
pub const _PyArg_VaParseTupleAndKeywordsFast = _PyArg_VaParseTupleAndKeywordsFast_SizeT;
...
pub const _cframe = struct__cframe;
