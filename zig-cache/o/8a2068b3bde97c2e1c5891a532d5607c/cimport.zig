...
pub extern fn futimesat(__fd: c_int, __file: [*c]const u8, __tvp: [*c]const struct_timeval) c_int; // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/timex.h:81:3: warning: struct demoted to opaque type - has bitfield
...
pub fn _PyObject_TypeCheck(arg_ob: [*c]PyObject, arg_type: [*c]PyTypeObject) callconv(.C) c_int {
    var ob = arg_ob;
    var @"type" = arg_type;
    return @boolToInt((_Py_IS_TYPE(@ptrCast([*c]const PyObject, @alignCast(@import("std").meta.alignment(PyObject), ob)), @"type") != 0) or (PyType_IsSubtype(ob.*.ob_type, @"type") != 0));
}
...
pub const sendfunc = ?fn ([*c]PyObject, [*c]PyObject, [*c][*c]PyObject) callconv(.C) PySendResult;
...
pub extern fn wmempcpy(noalias __s1: [*c]wchar_t, noalias __s2: [*c]const wchar_t, __n: usize) [*c]wchar_t; // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/wchar.h:320:11: warning: TODO implement function '__builtin_constant_p' in std.zig.c_builtins
// /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/wchar.h:319:8: warning: unable to translate function, demoted to extern
pub extern fn btowc(arg___c: c_int) callconv(.C) wint_t; // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/wchar.h:326:11: warning: TODO implement function '__builtin_constant_p' in std.zig.c_builtins
// /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/wchar.h:325:8: warning: unable to translate function, demoted to extern
...
pub const __GLIBC_USE = @compileError("unable to translate macro: undefined identifier `__GLIBC_USE_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/features.h:186:9
pub const __glibc_has_attribute = @compileError("unable to translate macro: undefined identifier `__has_attribute`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:44:10
pub const __glibc_has_builtin = @compileError("unable to translate macro: undefined identifier `__has_builtin`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:49:10
pub const __glibc_has_extension = @compileError("unable to translate macro: undefined identifier `__has_extension`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:54:10
pub const __THROW = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:78:11
pub const __THROWNL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:79:11
pub const __NTH = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:80:11
pub const __NTHNL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:81:11
pub const __CONCAT = @compileError("unable to translate C expr: unexpected token .HashHash"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:123:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token .Hash"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:124:9
pub const __warnattr = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:158:10
pub const __errordecl = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:159:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token .LBracket"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:167:10
pub const __REDIRECT = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:198:10
pub const __REDIRECT_NTH = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:205:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:207:11
pub const __ASMNAME2 = @compileError("unable to translate C expr: unexpected token .Identifier"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:211:10
pub const __attribute_malloc__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:232:10
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:243:10
pub const __attribute_pure__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:250:10
pub const __attribute_const__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:257:10
pub const __attribute_maybe_unused__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:263:10
pub const __attribute_used__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:272:10
pub const __attribute_noinline__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:273:10
pub const __attribute_deprecated__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:281:10
pub const __attribute_deprecated_msg__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:291:10
pub const __attribute_format_arg__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:304:10
pub const __attribute_format_strfmon__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:314:10
pub const __nonnull = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:324:11
pub const __returns_nonnull = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:337:10
pub const __attribute_warn_unused_result__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:346:10
pub const __always_inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:364:10
pub const __attribute_artificial__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:373:10
pub const __extern_inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:391:11
pub const __extern_always_inline = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:392:11
pub const __restrict_arr = @compileError("unable to translate macro: undefined identifier `__restrict`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:435:10
pub const __attribute_copy__ = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:484:10
pub const __LDBL_REDIR2_DECL = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:560:10
pub const __LDBL_REDIR_DECL = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:561:10
pub const __glibc_macro_warning1 = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:575:10
pub const __glibc_macro_warning = @compileError("unable to translate macro: undefined identifier `GCC`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:576:10
pub const __attr_access = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:612:11
pub const __attr_access_none = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:613:11
pub const __attr_dealloc = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:623:10
pub const __attribute_returns_twice__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/cdefs.h:630:10
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/include/stdarg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/include/stdarg.h:27:9
pub const __STD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/types.h:137:10
pub const __FSID_T_TYPE = @compileError("unable to translate macro: undefined identifier `__val`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/x86_64-linux-gnu/bits/typesizes.h:73:9
pub const __getc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:102:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:106:9
pub const __f32 = @compileError("unable to translate macro: undefined identifier `f`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:91:12
pub const __f64x = @compileError("unable to translate macro: undefined identifier `l`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:120:13
pub const __CFLOAT32 = @compileError("unable to translate: TODO _Complex"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:149:12
pub const __CFLOAT64 = @compileError("unable to translate: TODO _Complex"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:160:13
pub const __CFLOAT32X = @compileError("unable to translate: TODO _Complex"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:169:12
pub const __CFLOAT64X = @compileError("unable to translate: TODO _Complex"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:178:13
pub const __builtin_nansf32 = @compileError("unable to translate macro: undefined identifier `__builtin_nansf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:221:12
pub const __builtin_huge_valf64 = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:255:13
pub const __builtin_inff64 = @compileError("unable to translate macro: undefined identifier `__builtin_inf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:256:13
pub const __builtin_nanf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nan`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:257:13
pub const __builtin_nansf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nans`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:258:13
pub const __builtin_huge_valf32x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:272:12
pub const __builtin_inff32x = @compileError("unable to translate macro: undefined identifier `__builtin_inf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:273:12
pub const __builtin_nanf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nan`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:274:12
pub const __builtin_nansf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nans`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:275:12
pub const __builtin_huge_valf64x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:289:13
pub const __builtin_inff64x = @compileError("unable to translate macro: undefined identifier `__builtin_infl`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:290:13
pub const __builtin_nanf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nanl`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:291:13
pub const __builtin_nansf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/floatn-common.h:292:13
pub const strdupa = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/string.h:185:10
pub const strndupa = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/string.h:195:10
pub const __FD_ZERO = @compileError("unable to translate macro: undefined identifier `__i`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')' instead got: PipeEqual"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')' instead got: AmpersandEqual"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/select.h:34:9
pub const __PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/x86_64-linux-gnu/bits/struct_mutex.h:56:10
pub const __PTHREAD_RWLOCK_ELISION_EXTRA = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/x86_64-linux-gnu/bits/struct_rwlock.h:40:11
pub const __ONCE_FLAG_INIT = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/thread-shared-types.h:127:9
pub const TEMP_FAILURE_RETRY = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/unistd.h:1131:10
pub const __ASSERT_VOID_CAST = @compileError("unable to translate C expr: unexpected token .Eof"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/assert.h:40:10
pub const static_assert = @compileError("unable to translate C expr: unexpected token .Keyword_static_assert"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/assert.h:140:10
pub const __INT64_C = @compileError("unable to translate macro: undefined identifier `L`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/stdint.h:106:11
pub const __UINT64_C = @compileError("unable to translate macro: undefined identifier `UL`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/stdint.h:107:11
pub const INT64_C = @compileError("unable to translate macro: undefined identifier `L`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/stdint.h:252:11
pub const UINT32_C = @compileError("unable to translate macro: undefined identifier `U`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/stdint.h:260:10
pub const UINT64_C = @compileError("unable to translate macro: undefined identifier `UL`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/stdint.h:262:11
pub const INTMAX_C = @compileError("unable to translate macro: undefined identifier `L`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/stdint.h:269:11
pub const UINTMAX_C = @compileError("unable to translate macro: undefined identifier `UL`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/stdint.h:270:11
pub const Py_LOCAL = @compileError("unable to translate C expr: unexpected token .Keyword_static"); // /usr/include/python3.10/pyport.h:196:11
pub const Py_LOCAL_INLINE = @compileError("unable to translate C expr: unexpected token .Keyword_static"); // /usr/include/python3.10/pyport.h:197:11
pub const HUGE_VAL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:48:10
pub const HUGE_VALL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:60:11
pub const SNANF = @compileError("unable to translate macro: undefined identifier `__builtin_nansf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:110:11
pub const SNAN = @compileError("unable to translate macro: undefined identifier `__builtin_nans`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:111:11
pub const SNANL = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:112:11
pub const __SIMD_DECL = @compileError("unable to translate macro: undefined identifier `__DECL_SIMD_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:276:9
pub const __MATHCALL_VEC = @compileError("unable to translate C expr: unexpected token .Identifier"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:278:9
pub const __MATHDECL_VEC = @compileError("unable to translate C expr: unexpected token .Identifier"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:282:9
pub const __MATHDECL = @compileError("unable to translate macro: undefined identifier `__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:288:9
pub const __MATHDECLX = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:293:9
pub const __MATHDECL_1_IMPL = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:296:9
pub const __MATHREDIR = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:305:9
pub const __MATHCALL_NARROW_ARGS_1 = @compileError("unable to translate macro: undefined identifier `__x`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:550:9
pub const __MATHCALL_NARROW_ARGS_2 = @compileError("unable to translate macro: undefined identifier `__x`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:551:9
pub const __MATHCALL_NARROW_ARGS_3 = @compileError("unable to translate macro: undefined identifier `__x`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:552:9
pub const __MATHCALL_NARROW_NORMAL = @compileError("unable to translate macro: undefined identifier `__MATHCALL_NARROW_ARGS_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:553:9
pub const __MATHCALL_NARROW_REDIR = @compileError("unable to translate macro: undefined identifier `__MATHCALL_NARROW_ARGS_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:555:9
pub const __MATHCALL_NAME = @compileError("unable to translate macro: undefined identifier `f`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:565:10
pub const __MATH_TG = @compileError("unable to translate macro: undefined identifier `f`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:916:10
pub const fpclassify = @compileError("unable to translate macro: undefined identifier `__builtin_fpclassify`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:961:11
pub const isfinite = @compileError("unable to translate macro: undefined identifier `__builtin_isfinite`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:988:11
pub const isnormal = @compileError("unable to translate macro: undefined identifier `__builtin_isnormal`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:996:11
pub const __iscanonicalf = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/x86_64-linux-gnu/bits/iscanonical.h:25:9
pub const __iscanonical = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/x86_64-linux-gnu/bits/iscanonical.h:26:9
pub const iszero = @compileError("unable to translate macro: undefined identifier `__typeof`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:1088:12
pub const isgreater = @compileError("unable to translate macro: undefined identifier `__builtin_isgreater`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:1282:11
pub const isgreaterequal = @compileError("unable to translate macro: undefined identifier `__builtin_isgreaterequal`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:1283:11
pub const isless = @compileError("unable to translate macro: undefined identifier `__builtin_isless`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:1284:11
pub const islessequal = @compileError("unable to translate macro: undefined identifier `__builtin_islessequal`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:1285:11
pub const islessgreater = @compileError("unable to translate macro: undefined identifier `__builtin_islessgreater`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:1286:11
pub const isunordered = @compileError("unable to translate macro: undefined identifier `__builtin_isunordered`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/math.h:1287:11
pub const TIMEVAL_TO_TIMESPEC = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/time.h:38:10
pub const TIMESPEC_TO_TIMEVAL = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/time.h:42:10
pub const timerclear = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/time.h:232:10
pub const timercmp = @compileError("unable to translate C expr: expected ')' instead got: Identifier"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/time.h:233:10
pub const timeradd = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/time.h:237:10
pub const timersub = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sys/time.h:247:10
pub const st_atime = @compileError("unable to translate macro: undefined identifier `st_atim`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/x86_64-linux-gnu/bits/struct_stat.h:77:11
pub const st_mtime = @compileError("unable to translate macro: undefined identifier `st_mtim`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/x86_64-linux-gnu/bits/struct_stat.h:78:11
pub const st_ctime = @compileError("unable to translate macro: undefined identifier `st_ctim`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/x86_64-linux-gnu/bits/struct_stat.h:79:11
pub const __struct_group = @compileError("unable to translate C expr: expected ')'"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/any-linux-any/linux/stddef.h:23:9
pub const __DECLARE_FLEX_ARRAY = @compileError("unable to translate macro: undefined identifier `__empty_`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/any-linux-any/linux/stddef.h:39:9
pub const __aligned_u64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/any-linux-any/linux/types.h:43:9
pub const __aligned_be64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/any-linux-any/linux/types.h:44:9
pub const __aligned_le64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/any-linux-any/linux/types.h:45:9
pub const _Py_SET_EDOM_FOR_NAN = @compileError("unable to translate C expr: unexpected token .Semicolon"); // /usr/include/python3.10/pyport.h:335:9
pub const Py_SET_ERRNO_ON_MATH_ERROR = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /usr/include/python3.10/pyport.h:337:9
pub const Py_ADJUST_ERANGE1 = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /usr/include/python3.10/pyport.h:365:9
pub const Py_ADJUST_ERANGE2 = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /usr/include/python3.10/pyport.h:375:9
...
pub const PyAPI_DATA = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /usr/include/python3.10/pyport.h:706:16
...
pub const Py_LL = @compileError("unable to translate macro: undefined identifier `LL`"); // /usr/include/python3.10/pyport.h:780:9
...
pub const _Py__has_builtin = @compileError("unable to translate macro: undefined identifier `__has_builtin`"); // /usr/include/python3.10/pyport.h:883:11
pub const _Py_XSTRINGIFY = @compileError("unable to translate C expr: unexpected token .Hash"); // /usr/include/python3.10/pymacro.h:13:9
pub const Py_MEMBER_SIZE = @compileError("unable to translate C expr: unexpected token .LParen"); // /usr/include/python3.10/pymacro.h:22:9
pub const Py_BUILD_ASSERT_EXPR = @compileError("unable to translate C expr: expected ')'"); // /usr/include/python3.10/pymacro.h:39:9
pub const Py_BUILD_ASSERT = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /usr/include/python3.10/pymacro.h:42:9
...
pub const PyDoc_VAR = @compileError("unable to translate C expr: unexpected token .Keyword_static"); // /usr/include/python3.10/pymacro.h:70:9
pub const PyDoc_STRVAR = @compileError("unable to translate C expr: unexpected token .Equal"); // /usr/include/python3.10/pymacro.h:71:9
...
pub const Py_UNREACHABLE = @compileError("unable to translate macro: undefined identifier `__builtin_unreachable`"); // /usr/include/python3.10/pymacro.h:124:11
...
pub const PyMem_New = @compileError("unable to translate C expr: unexpected token .RParen"); // /usr/include/python3.10/pymem.h:67:9
pub const PyMem_Resize = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // /usr/include/python3.10/pymem.h:77:9
...
pub const PyObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token .LBrace"); // /usr/include/python3.10/object.h:84:9
pub const PyVarObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token .LBrace"); // /usr/include/python3.10/object.h:88:9
...
pub const _PyObject_CAST_CONST = @compileError("unable to translate C expr: unexpected token .Keyword_const"); // /usr/include/python3.10/object.h:113:9
pub const _PyVarObject_CAST_CONST = @compileError("unable to translate C expr: unexpected token .Keyword_const"); // /usr/include/python3.10/object.h:122:9
...
pub const Py_RETURN_NONE = @compileError("unable to translate C expr: unexpected token .Keyword_return"); // /usr/include/python3.10/object.h:613:9
pub const Py_RETURN_NOTIMPLEMENTED = @compileError("unable to translate C expr: unexpected token .Keyword_return"); // /usr/include/python3.10/object.h:623:9
pub const Py_RETURN_RICHCOMPARE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /usr/include/python3.10/object.h:647:9
pub const _Py_static_string_init = @compileError("unable to translate C expr: unexpected token .LBrace"); // /usr/include/python3.10/cpython/object.h:44:9
pub const _Py_static_string = @compileError("unable to translate C expr: unexpected token .Keyword_static"); // /usr/include/python3.10/cpython/object.h:45:9
...
pub const PyHeapType_GET_MEMBERS = @compileError("unable to translate C expr: unexpected token .RParen"); // /usr/include/python3.10/cpython/object.h:296:9
...
pub const PyObject_New = @compileError("unable to translate C expr: unexpected token .RParen"); // /usr/include/python3.10/objimpl.h:134:9
pub const PyObject_NewVar = @compileError("unable to translate C expr: unexpected token .RParen"); // /usr/include/python3.10/objimpl.h:140:9
pub const PyObject_GC_Resize = @compileError("unable to translate C expr: unexpected token .RParen"); // /usr/include/python3.10/objimpl.h:164:9
pub const PyObject_GC_New = @compileError("unable to translate C expr: unexpected token .RParen"); // /usr/include/python3.10/objimpl.h:184:9
pub const PyObject_GC_NewVar = @compileError("unable to translate C expr: unexpected token .RParen"); // /usr/include/python3.10/objimpl.h:186:9
...
pub const __exctype = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/ctype.h:102:9
pub const __tobody = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/ctype.h:155:9
pub const __exctype_l = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/ctype.h:244:10
pub const PyUnicode_AS_DATA = @compileError("unable to translate C expr: unexpected token .Keyword_const"); // /usr/include/python3.10/cpython/unicodeobject.h:282:9
pub const PyUnicode_WRITE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /usr/include/python3.10/cpython/unicodeobject.h:363:9
pub const PyUnicode_READ = @compileError("unable to translate C expr: unexpected token .Keyword_const"); // /usr/include/python3.10/cpython/unicodeobject.h:383:9
pub const PyUnicode_READ_CHAR = @compileError("unable to translate C expr: unexpected token .Keyword_const"); // /usr/include/python3.10/cpython/unicodeobject.h:397:9
pub const Py_RETURN_TRUE = @compileError("unable to translate C expr: unexpected token .Keyword_return"); // /usr/include/python3.10/boolobject.h:34:9
pub const Py_RETURN_FALSE = @compileError("unable to translate C expr: unexpected token .Keyword_return"); // /usr/include/python3.10/boolobject.h:35:9
pub const Py_RETURN_NAN = @compileError("unable to translate C expr: unexpected token .Keyword_return"); // /usr/include/python3.10/floatobject.h:27:9
pub const Py_RETURN_INF = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /usr/include/python3.10/floatobject.h:30:9
pub const PyTuple_SET_ITEM = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // /usr/include/python3.10/cpython/tupleobject.h:26:9
pub const PyList_SET_ITEM = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // /usr/include/python3.10/cpython/listobject.h:33:9
pub const PyModuleDef_HEAD_INIT = @compileError("unable to translate C expr: unexpected token .LBrace"); // /usr/include/python3.10/moduleobject.h:51:9
...
pub const PyCell_SET = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // /usr/include/python3.10/cellobject.h:23:9
...
pub const __CPU_ZERO_S = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/cpu-set.h:46:10
pub const __CPU_SET_S = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/cpu-set.h:58:9
pub const __CPU_CLR_S = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/cpu-set.h:65:9
pub const __CPU_ISSET_S = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/cpu-set.h:72:9
pub const __CPU_EQUAL_S = @compileError("unable to translate macro: undefined identifier `__builtin_memcmp`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/cpu-set.h:84:10
pub const __CPU_OP_S = @compileError("unable to translate macro: undefined identifier `__extension__`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/bits/cpu-set.h:99:9
pub const CPU_AND = @compileError("unable to translate C expr: unexpected token .RParen"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sched.h:111:10
pub const CPU_OR = @compileError("unable to translate C expr: unexpected token .Pipe"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sched.h:113:10
pub const CPU_XOR = @compileError("unable to translate C expr: unexpected token .Caret"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sched.h:115:10
pub const CPU_AND_S = @compileError("unable to translate C expr: unexpected token .RParen"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sched.h:117:10
pub const CPU_OR_S = @compileError("unable to translate C expr: unexpected token .Pipe"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sched.h:119:10
pub const CPU_XOR_S = @compileError("unable to translate C expr: unexpected token .Caret"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/sched.h:121:10
pub const PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:90:9
pub const PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:93:10
pub const PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:95:10
pub const PTHREAD_ADAPTIVE_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:97:10
pub const PTHREAD_RWLOCK_INITIALIZER = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:114:10
pub const PTHREAD_RWLOCK_WRITER_NONRECURSIVE_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:117:11
pub const PTHREAD_COND_INITIALIZER = @compileError("unable to translate C expr: unexpected token .LBrace"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:155:9
pub const pthread_cleanup_push = @compileError("unable to translate macro: undefined identifier `__cancel_buf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:681:10
pub const pthread_cleanup_pop = @compileError("unable to translate macro: undefined identifier `__cancel_buf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:702:10
pub const pthread_cleanup_push_defer_np = @compileError("unable to translate macro: undefined identifier `__cancel_buf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:716:11
pub const pthread_cleanup_pop_restore_np = @compileError("unable to translate macro: undefined identifier `__cancel_buf`"); // /media/lucifer/STORAGE/IMPORTANTS/CODE/Zig/zig/lib/libc/include/generic-glibc/pthread.h:738:11
pub const Py_tss_NEEDS_INIT = @compileError("unable to translate C expr: unexpected token .LBrace"); // /usr/include/python3.10/pythread.h:151:9
pub const PyModule_AddIntMacro = @compileError("unable to translate C expr: unexpected token .Hash"); // /usr/include/python3.10/modsupport.h:154:9
pub const PyModule_AddStringMacro = @compileError("unable to translate C expr: unexpected token .Hash"); // /usr/include/python3.10/modsupport.h:155:9
...
pub inline fn PyUnicode_GET_SIZE(op: anytype) @TypeOf(if (@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr) PyUnicode_WSTR_LENGTH(op) else blk: {
    ...
    return blk: {
        ...
        break :blk if (@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr) PyUnicode_WSTR_LENGTH(op) else blk: {
            _ = @import("std").zig.c_translation.cast(anyopaque, PyUnicode_AsUnicode(_PyObject_CAST(op)));
            _ = assert(@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr);
            break :blk PyUnicode_WSTR_LENGTH(op);
        };
